...
second_bar = bar.Bar(
        [
            ...
            set_icon(' ', group_colors[3]),
            right_triangle(group_colors[2], group_colors[3]),
            # End Group three
            ...
            set_icon(" ", group_colors[2]),
            right_triangle(group_colors[1], group_colors[2]),
            # End Group two
            ...
            set_icon(' ', group_colors[1]),
            right_triangle(bar_theme['color'], group_colors[1]),
            # End Group one
            ...
            widget.WindowName( foreground=window_name['text_color'],
                background=window_name['background'],
                max_chars=window_name['max_chars']
                ),
                separator(bar_theme['color']),
            ...
            left_triangle(bar_theme['color'], group_box['background']),
            widget.GroupBox(
                active=theme['active'],
                inactive=theme['inactive'],
                borderwidth=group_box['border_width'],
